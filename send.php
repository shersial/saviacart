...
<html lang="ar" dir="rtl">
	<head>
		...
		<!-- TITLE -->
		<title>سفياكارت لخدمات الويب المتنوعة - تواصل معنا</title>
						...
						<div class="row">
							...
							<div class="collapse navbar-collapse" id="collapse">
								...
								<ul class="nav navbar-nav navbar-left" id="navbar">
									...
									<li id="flag"><a href="en/index.html"><img src="img/en.png" alt="" /> EN</a></li>
									<li id="opencart"><a href="contact.html"> <i class="fa fa-ticket"></i> فتح تذكرة</a></li>
								</ul>
							</div><!-- /.navbar-collapse -->
						</div>
					</div><!-- /.container -->
	...
	if (!$error) {
	    ...
	    if ($send) {
	    ?>
						<h2 id="send-t">لقد تم ارسال الرسالة سيتم التواصل معك في أقرب وقت :)</h2>
						
		<?php
	    } else {
	        // If the message is not send return error
	    ?>				
						<h2 id="send-f">يبدوا أن هنالك خطأ المرجوا إعادة المحاولة :(</h2>
		<?php
			}
		} else {
		?>
			...
			<div class="container">
				<div class="row">
					...
					<div class="sub-footer">
						<h5>جميع الحقوق محفوظة لدى شركة سفياكارت © 2021</h5>
					</div>
